...
\begin{itemize}
\item Discard cells where glider attitude causes beam miss of $> 1$ m as the beam swill be sampling different bins \hyperlink{flight_envelope}{\beamerbutton{see plot}}
...
\item What if we don't apply this quality control? \hyperlink{no_qc}{\beamerbutton{see plot}}
\end{itemize}
\end{frame}
